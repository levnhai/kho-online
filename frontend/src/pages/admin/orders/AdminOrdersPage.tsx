...
import { Search, Eye, CheckCircle2, AlertCircle, ShoppingBag, Filter } from 'lucide-react';
                  ...
                  return (
                    <tr key={ord._id} className="hover:bg-gray-50/60 dark:hover:bg-slate-700/40 transition-colors">
                      ...
                      <td className="py-3.5 px-3 whitespace-nowrap">
                        ...
                        >
                          <option value="PENDING" className="bg-white dark:bg-slate-900 text-amber-600 dark:text-amber-400 font-bold py-1">Chờ xác nhận</option>
                          <option value="CONFIRMED" className="bg-white dark:bg-slate-900 text-blue-600 dark:text-blue-400 font-bold py-1">Đã xác nhận</option>
                          <option value="SHIPPING" className="bg-white dark:bg-slate-900 text-indigo-600 dark:text-indigo-400 font-bold py-1">Đang giao</option>
                          <option value="DELIVERED" className="bg-white dark:bg-slate-900 text-emerald-600 dark:text-emerald-400 font-bold py-1">Đã giao</option>
                          <option value="CANCELLED" className="bg-white dark:bg-slate-900 text-rose-600 dark:text-rose-400 font-bold py-1">Hủy đơn</option>
                        </select>
                      </td>
        ...
        >
          <div className="space-y-4 text-xs max-h-[75vh] overflow-y-auto pr-1">
            ...
            <div className="p-3 rounded-2xl bg-blue-50 dark:bg-blue-950/50 border border-blue-100 dark:border-blue-900 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2">
              ...
              >
                <option value="PENDING" className="bg-white dark:bg-slate-900 text-amber-600 dark:text-amber-400 font-bold py-1">1. Chờ xác nhận</option>
                <option value="CONFIRMED" className="bg-white dark:bg-slate-900 text-blue-600 dark:text-blue-400 font-bold py-1">2. Đã xác nhận</option>
                <option value="SHIPPING" className="bg-white dark:bg-slate-900 text-indigo-600 dark:text-indigo-400 font-bold py-1">3. Đang giao</option>
                <option value="DELIVERED" className="bg-white dark:bg-slate-900 text-emerald-600 dark:text-emerald-400 font-bold py-1">4. Đã giao</option>
                <option value="CANCELLED" className="bg-white dark:bg-slate-900 text-rose-600 dark:text-rose-400 font-bold py-1">Hủy đơn hàng</option>
              </select>
            </div>
